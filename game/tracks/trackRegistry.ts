...
export const TRACKS: TrackConfig[] = [
  ...
  },
  {
    ...
    laps: 4,
    difficulty: 2,
    description: 'A longer street circuit through a glowing metropolis. Unforgiving barriers and technical chicanes demand precision.',
    stats: { length: '2.6 km', turns: 16, topSpeed: '160 km/h' },
    accentColor: '#bf5fff',
    bgColor: '#0a001a',
  },
  {
    ...
    stats: { length: '4.6 km', turns: 15, topSpeed: '200 km/h' },
    accentColor: '#00c8ff',
    bgColor: '#001a2a',
  },
]